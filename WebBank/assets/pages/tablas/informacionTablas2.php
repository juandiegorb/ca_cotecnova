...
while ($resultado= mysqli_fetch_assoc($historial)){
  if ($resultado["id_usuario"] == $id_usuario1 && $resultado["id_transacion"]==1) {
    ...
    $usuario2 = $mysql->efectuarConsulta("SELECT numero_cedula, primer_nombre, primer_apellido FROM usuario WHERE id_usuario = '".$id_usuario2[$i]."'");
